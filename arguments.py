...
def get_args():
    ...
    parser.add_argument('--env-name', type=str, default='SharedReach-v0', help='the environment name')
    ...
    parser.add_argument('--seed', type=int, default=190503, help='random seed')
    ...
    parser.add_argument('--clip-range', type=float, default=15, help='the clip range')
